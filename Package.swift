...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ACPCore",
            url: "https://github.com/genadyb/ios_adobe_extension/releases/download/v1.0.3/ACPCore.xcframework-2.9.5.zip",
            checksum: "1feb78e211bfc1d4e52e499323772f66c3eaab56434342465f7ee8a036a51fa9"
        ),
        .binaryTarget(
            name: "ACPIdentity",
            url: "https://github.com/genadyb/ios_adobe_extension/releases/download/v1.0.3/ACPIdentity.xcframework-2.5.2.zip",
            checksum: "9a4843568ad0832e575dbecb2524265bbfd9baf2557bc972f78b4359d70f8bc0"
        ),
        .binaryTarget(
            name: "ACPLifecycle",
            url: "https://github.com/genadyb/ios_adobe_extension/releases/download/v1.0.3/ACPLifecycle.xcframework-2.2.1.zip",
            checksum: "02d7b6a1c615d9f5b222d58a95a0ded1ce4b1dac60fbecc9858d9e8dcd74c2eb"
        ),
        .binaryTarget(
            name: "ACPSignal",
            url: "https://github.com/genadyb/ios_adobe_extension/releases/download/v1.0.3/ACPSignal.xcframework-2.2.0.zip",
